...
public class ReceiveCommunicationWithSiloBehaviour extends SimpleBehaviour{
	...
	public void action() {
		...
		// 3.5) print
		if (verbose) {
			System.out.println(this.myAgent.getLocalName()+" received a communication from " + msgReceived.getSender().getLocalName());
			System.out.println(this.myAgent.getLocalName()+" it contains : " + contents);
		}
